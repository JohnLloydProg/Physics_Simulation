...
class PymunkObject:
    ...
    def __init__(self, mass:float=10.0, friction:float=0.5, elasticity:float=0.5, body_type:int=pk.Body.DYNAMIC):
        self.mass = mass
    ...
    def clicked(self, event:pg.event.Event) -> tuple[float, float]:
